...
import exam_main.music_app.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.FloatField(validators=[exam_main.music_app.models.valid_price])),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(max_length=15, validators=[django.core.validators.MinLengthValidator(2), exam_main.music_app.models.username_valid_name])),
